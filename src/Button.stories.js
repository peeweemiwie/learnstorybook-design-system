...
export const AllButtons = (args) => (
	<div>
		<div>
			<SectionTitle>Theme colors: Medium </SectionTitle>
		...
		<Button appearance='success' size='small'>
			Success
		</Button>
...
export const buttonWrapper = (args) => (
	<div>
		...
		<Button ButtonWrapper={ButtonWrapper} appearance='success'>
			Success
		</Button>
		...
		<Button ButtonWrapper={ButtonWrapper} appearance='success' isLoading>
			Success
		</Button>
		...
		<Button ButtonWrapper={ButtonWrapper} appearance='success' size='small'>
			Success
		</Button>
