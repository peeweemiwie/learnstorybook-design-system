...
const StyledButton = styled.button`
	...
	transition: typography all 150ms ease-out;
	...
	font-size: ${(props) =>
		props.size === SIZES.SMALL ? typography.size.s1 : typography.size.s2}rem;
  ...
  ${(props) =>
      ...
      ${
				...
				`
          &:hover {
            background: ${darken(0.05, color.success)};
          }
          &:active {
            box-shadow: rgba(0, 0, 0, 0.1) 0 0 0 3em inset;
          }
          &:focus {
            box-shadow: ${rgba(color.success, 0.4)} 0 1px 9px 2px;
          }
          &:focus:hover {
            box-shadow: ${rgba(color.success, 0.2)} 0 8px 18px 0px;
          }
        `
			}
    `}
